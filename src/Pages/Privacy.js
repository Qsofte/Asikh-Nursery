...
const Privacy = () => {
    ...
    <>
              <div className="txt-cntnt">
                ...
                <p>
                    This Privacy Notice for Asikh Nursery(doing business as Asikh Nursery) ('we', 
                    'us', or 'our'), describes how and why we might access, collect, store, use, and/
                    or share ('process') your personal information when you use our services 
                    ('Services'), including when you:
                </p>
                <ul>
                  <li>Visit our website at http://www.Asikhnursery.in, or any website of ours 
                  that links to this Privacy Notic</li>
                  <li>Engage with us in other related ways, including any sales, marketing, 
                  or events</li>
                </ul>
                <p>
                    ...
                    use our Services. If you still have any questions or concerns, please contact us 
                    at support@Asikhnursery.in.
                </p>
               <h1>SUMMARY OF KEY POINTS</h1>
                  ...
                  may be considered 'special' or
                  'sensitive' in certain jurisdictions, for example your racial or ethnic origins, 
                  sexual orientation, and religious beliefs. We do not process sensitive personal 
                  information
                  </p>
                  ...
                  unauthorised third parties will not be able to defeat our security and improperly 
                  ...
                  <h2>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL</h2>
                  ...
                  <ul>
                    ...
                    estimate your location. GPS is accurate to about 20 meters, while WiFi and cell towers help improve accuracy when GPS signals are weak, 
                    like indoors. This data helps Google Maps provide directions, but it is 
                    not always perfectly precise.
                    </li>
                    <li>
                    Affiliates. We may share your information with our affiliates, in which 
                    case we will require those affiliates to honour this Privacy Notice. 
                  ...
                  use of the Services. To opt out of being tracked by Google Analytics across the 
                  Services visit https://tools.google.com/dlpage/gaoptout For more information 
                  on the privacy practices of google, please visit https://policies.google.com/
                  privacy
                  </p>
                  ...
                  <p>
                    ...
                    by replying 'STOP' or 'UNSUBSCRIBE' to the SMS messages that we send, or 
                    ...
                    send you service-related messages that are necessary for the administration 
                  ...
                  <p>
                    ...
                    to signal your privacy preference not to have data about Four online browsing 
                  ...
                  <h2>11. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE
                  COLLECT FROM YOU?</h2>
                  ...
                  information, please fill out and submit a data subject access request @ https://
